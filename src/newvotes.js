...
document.addEventListener("DOMContentLoaded", () => {
    ...
    auth.onAuthStateChanged(async (user) => {
        ...
        const userRef = doc(db, "newusers", userEmail); // Reference the user's document
        ...
        // Check if user has already voted in "newvotes"
        const voteRef = doc(db, "newvotes", userEmail); // Changed from "votes" to "newvotes"
...
async function submitVotes() {
    ...
    try {
        await setDoc(doc(db, "newvotes", userEmail), { // Changed from "votes" to "newvotes"
            email: userEmail,
            username: userName,
            votes: selectedVotes,
