...
async function fetchUsers() {
    ...
    try {
        const usersSnapshot = await getDocs(collection(db, "newusers"));
        const votesSnapshot = await getDocs(collection(db, "newvotes"));
...
async function fetchVotes() {
    ...
    try {
        ...
        totalCandidatesElem.innerText = 2; // Fixed number of candidates
    } catch (error) {
